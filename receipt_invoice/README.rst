...
This module extends the functionality of Payment receipt and duplicate customers
**Table of contents**
...
1. Payment receipt and duplicate customers
...
This module is part of the `Custom-eventosdistintos <https://gitlab.com/calyx-servicios/custom-eventosdistintos>`_ project on Gitlab.